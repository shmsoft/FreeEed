...
(function($) {
    $.fn.ajaxfileupload = function(options) {
        var settings = {
          ...
          submit_button : $("#uploadfilebutton")
        };
        ...
        return this.each(function() {
          ...
          var upload_file = function()
          {
            ...
            if($.inArray(ext, settings.valid_extensions) == -1)
            {
              ...
              settings.onComplete.apply($element, ['{"status":"error"}', settings.params]);
            } else
            { 
              uploading_file = true;
          ...
          */
          var handleResponse = function(loadedFrame, element) {
            var response = loadedFrame.contentWindow.document.body.innerHTML;

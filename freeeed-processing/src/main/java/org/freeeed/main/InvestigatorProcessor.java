...
/**
 * Investigate file for responsiveness to a query
 */
public class InvestigatorProcessor extends FileProcessor {
    private final static Logger LOGGER = LogFactory.getLogger(InvestigatorProcessor.class.getName());
     ...
     * @param luceneIndex
     */
    public InvestigatorProcessor(String singleFileName, MetadataWriter metadataWriter, LuceneIndex luceneIndex) {

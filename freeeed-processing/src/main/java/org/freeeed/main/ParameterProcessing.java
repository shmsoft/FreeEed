...
public class ParameterProcessing {
    ...
    public static final String FLAT_INPUT_FILE_NAME = "flat-input";
    ...
    public static final String PROVIDER_API_KEY = "provider_api_key";
    ...
    public static String PREMIUM_FEATURES = "premium_features";

...
public class SolrConnector {
    ...
    private void createSolrDoc(Map<String, String> data, StringBuilder param) {
        param.append("<doc>");
        param.append("<field name=\"id\">").append(data.get(DocumentMetadata.UNIQUE_ID)).append("</field>");
